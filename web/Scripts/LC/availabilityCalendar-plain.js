...
/***** CALENDAR WORK HOURS *****/
var LcWidget = require('./CX/LcWidget');

exports.WorkHours = function WorkHours(element, options) {
  LcWidget.call(this, element, options);

  this.user = this.$el.data('calendar-user');

  // TODO: How place default queryData? Add to DataSource
  // TODO: Add generic Event class and implement on DataSource too.
  var queryData = {
    user: user,
    type: 'workhours'
  };
