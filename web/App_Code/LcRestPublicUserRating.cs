...
/// </summary>
public class LcRestPublicUserRating
{
    #region Fields
    ...
    public static LcRestPublicUserRating FromDB(dynamic record)
    {
        if (record == null) return null;
        return new LcRestPublicUserRating {
    ...
    ///
    public static LcRestPublicUserRating Get(int userID, int jobTitleID)
    {
