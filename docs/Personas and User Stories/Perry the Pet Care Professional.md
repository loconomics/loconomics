...
------------ | ------------- | ------------- | ------------- | -------------
A) I want to manage my schedule easily. | A1) I want a calendar to ensure all my gigs work together timewise (there's a window) and location. Logistics.  |  | [1076](/issues/1076) | 
