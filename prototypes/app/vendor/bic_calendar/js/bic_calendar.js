 ...
 *
 *  Changes: IagoSRL, Loconomics Coop.
 */
(function( $ ) {
    var methods = {
        ...
        changeDate: function(month, year) {
            return $(this).each(function() {
                var instance = $(this).data('bic_calendar');
                instance.changeDate(month, year);
            });
        },
        instance: function() {
            return $(this).data('bic_calendar');
        }
    };
     
    $.fn.bic_calendar = function(methodOrOptions) {
