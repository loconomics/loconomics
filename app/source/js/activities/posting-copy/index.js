 ...
 * a new entry.
 *
 * @module activities/posting-copy
 *
 */
...
const ROUTE_NAME = 'posting-copy';

export default class PostingCopyActivity extends Activity {
...
activities.register(ROUTE_NAME, PostingCopyActivity);
