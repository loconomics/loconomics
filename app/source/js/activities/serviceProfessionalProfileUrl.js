/**
    ServiceProfessionalProfileUrl activity
    
    NOTE: Mostly like ServiceProfessionalWebsite activity
**/
'use strict';
...
var A = Activity.extend(function ServiceProfessionalProfileUrlActivity() {
    ...
    this.registerHandler({
        ...
        handler: function(err) {
            var msg = err.task === 'save' ? 'Error saving your custom URL.' : 'Error loading your custom URL.';
