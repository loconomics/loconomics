 ...
 * Loconomics.
 *
 * @module activities/listing-solutions-edit
 *
 */

import '../../kocomponents/listing/solutions';
import '../../utils/Time';
...
const ROUTE_NAME = 'listing-solutions-edit';

export default class ListingSolutionsEditActivity extends Activity {
    ...
    constructor($activity, app) {
        ...
        this.title = 'Edit Listing Solutions';
    }
}

activities.register(ROUTE_NAME, ListingSolutionsEditActivity);
