...
var A = Activity.extend(function WelcomeHealingArtsProfessionalsActivity() {
...
function ViewModel(app) {
    ...
    this.search().jobTitleHref('#welcomeHealingArtsProfessionals-signup');
    this.search().noJobTitleHref('#welcomeHealingArtsProfessionals-signup');
}
