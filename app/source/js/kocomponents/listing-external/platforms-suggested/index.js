...
const className = 'PlatformsSuggested';
const TAG_NAME = 'listing-external-platforms-suggested';
const dummyData = {};
dummyData[-1] =
[
  {
 ...
 * Component
 */
export default class PlatformsSuggested extends Komponent {
...
ko.components.register(TAG_NAME, PlatformsSuggested);
